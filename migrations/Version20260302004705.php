 ...
 */
final class Version20260302004705 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_BA388B7A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE product_rating (id INT AUTO_INCREMENT NOT NULL, stars INT DEFAULT NULL, comment LONGTEXT DEFAULT NULL, created_at DATETIME DEFAULT NULL, user_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_BAF56786A76ED395 (user_id), INDEX IDX_BAF567864584665A (product_id), UNIQUE INDEX unique_rating (user_id, product_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
