 ...
 */
final class Version20260221131536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD google2fa_secret VARCHAR(255) DEFAULT NULL, ADD is_2fa_enabled TINYINT NOT NULL, ADD google_oauth_id VARCHAR(255) DEFAULT NULL, ADD oauth_provider VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP google2fa_secret, DROP is_2fa_enabled, DROP google_oauth_id, DROP oauth_provider');
    }
}
