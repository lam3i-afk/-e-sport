 ...
 */
final class Version20260302161556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product_rating CHANGE created_at created_at DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE wishlist CHANGE added_at added_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart CHANGE created_at created_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE product_rating CHANGE created_at created_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE wishlist CHANGE added_at added_at DATETIME NOT NULL');
    }
}
