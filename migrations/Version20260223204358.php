 ...
 */
final class Version20260223204358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD face_encoding LONGTEXT DEFAULT NULL, ADD is_face_enabled TINYINT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP face_encoding, DROP is_face_enabled');
    }
}
